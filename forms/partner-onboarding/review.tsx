    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          />
          <LabelAndValue label="GST Number" value={formData.gstNumber} />
          <LabelAndValue
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <LabelAndValue
            ...
            value={formData.businessRegistration?.name || "Not Uploaded"}
          />
          <LabelAndValue
            label="Tax Registration"
            value={formData.taxRegistration?.name || "Not Uploaded"}
          />
          <LabelAndValue
            label="Bank Statement"
            value={formData.bankStatement?.name || "Not Uploaded"}
          />
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <LabelAndValue label="Confirm Password" value="••••••••" />
        </div>
      </div>
    </div>
  );
